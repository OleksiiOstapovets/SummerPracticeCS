...
sudo netdiscover -r 10.0.2.0/24 працює швидше, оскільки виконує активне сканування зазначеного діапазону IP-адрес за допомогою ARP-запитів
...
-A виконує комплексне сканування.

-sV визначає лише версії сервісів.

Отримуємо наступне:

![приклад використання nmap](pic1.png)
...
![php-reverse-shell.php](pic9.png)
...
![reverse-shell-is-working](pic11.png)
